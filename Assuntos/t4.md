...
Planetas podem morrer por colisão, como está no código do exemplo2.
Podem também morrer por solidão (a distância dele para qualquer outro planeta é superior a um certo limite).
...
Use um double para acumular os pontos, e um formato razoável para representá-los (dividindo por uma constante se aumentarem rápido demais).
...
A tela deve mostrar os pontos acumulados e o tempo restante.
