...
```c
  ...
  // para realizar o cálculo, por enquanto chama uma função "calcula", que recebe a expressão a calcular e retorna um double
  double cel_valor(celula cel);
...
dicionadio dicionario_global_que_vai_sumir;
