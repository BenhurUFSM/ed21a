...
Não garanto que os códigos estejam corretos, foram feitos direto no editor de texto, nem foram compilados (pelo menos não é um editor que completa as linhas sozinho e deixa sem os ;)...
Se achar um erro, avisa.
